...
export default function WalletComponent({ closeModal }) {
  ...
  const [hoveredConnectorButtons, setHoveredConnectorButtons] = React.useState(
    new Map()
  );
    ...
    >
        ...
        return (
          ...
          >
            <Button
              ...
              onClick={() => {
                connected
                  ? onDeactivateClicked(deactivate, currentConnector)
                  : onConnectionClicked(
                      currentConnector,
                      name,
                      setActivatingConnector,
      ...
      <div style={{ width: "252px", margin: "12px 0px" }}>
        <Button
          ...
          color="primary"
          onClick={() => {
            onDeactivateClicked(deactivate, connector || localConnector);
          }}
        >
          <Typography
            style={{
